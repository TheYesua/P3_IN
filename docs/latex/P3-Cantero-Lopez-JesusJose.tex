...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        \hline
        \textbf{Nº} & \textbf{Fecha/Hora} & \textbf{Pos.} & \textbf{F1 Train} & \textbf{F1 Kaggle} \\
        \hline
        01 & 23/12/2025 20:30 & 1 & 0.8278 & 0.8478 \\
        \hline
        02 & 25/12/2025 18:46 & -- & 0.7368 & [PENDIENTE] \\
        \hline
        03 & 25/12/2025 18:47 & -- & 0.7268 & [PENDIENTE] \\
        \hline
        04 & 25/12/2025 18:46 & -- & 0.6802 & [PENDIENTE] \\
        \hline
        05 & 25/12/2025 18:48 & -- & 0.7472 & [PENDIENTE] \\
        \hline
        06 & 25/12/2025 18:48 & -- & 0.7232 & [PENDIENTE] \\
        \hline
    \end{tabular}
...
\begin{table}[H]
    \centering
    \footnotesize
    \begin{tabular}{|c|p{3cm}|p{2.5cm}|p{4cm}|}
        \hline
        \textbf{Nº} & \textbf{Preprocesado} & \textbf{Algoritmo} & \textbf{Parámetros} \\
        \hline
        01 & StandardScaler & LogisticRegression & max\_iter=1000, random\_state=42 \\
        \hline
        02 & StandardScaler+PCA(3) & LogisticRegression & max\_iter=1000, random\_state=42 \\
        \hline
        03 & StandardScaler+PCA(7) & XGBoost & n\_estimators=100, max\_depth=6 \\
        \hline
        04 & StandardScaler+SKB(50) & RandomForest & n\_estimators=100, class\_weight='balanced' \\
        \hline
        05 & StandardScaler & XGBoost & n\_estimators=100, max\_depth=6 \\
        \hline
        06 & StandardScaler & LightGBM & n\_estimators=100, max\_depth=6 \\
        \hline
    \end{tabular}
    \caption{Detalle de preprocesado, algoritmos y parámetros por experimento.}
    \label{tab:experimentos_detalle}
\end{table}
...
\begin{enumerate}
    \item \textbf{Logistic Regression sigue siendo el mejor modelo} con F1 = 0.8278.
    \item \textbf{XGBoost y LightGBM requieren optimización} de hiperparámetros para competir.
    \item \textbf{La alta varianza} en modelos avanzados sugiere overfitting con parámetros por defecto.
    \item \textbf{Las features espectrales son más discriminativas} que las de fluorescencia.
\end{enumerate}
