"""
Experimento 10: SVM con optimización de hiperparámetros
Práctica 3 - Competición Kaggle

Objetivo: SVM mostró buen rendimiento en baseline. Optimizar kernel y parámetros
para intentar superar a Logistic Regression.
"""
...
def main():
    print("=" * 60)
    print("EXPERIMENTO 10: SVM OPTIMIZADO")
    ...
    submission_filename = SUBMISSIONS_PATH / f'submission_10_svm_optimized_{timestamp}.csv'
