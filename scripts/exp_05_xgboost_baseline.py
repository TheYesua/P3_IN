"""
Experimento 05: XGBoost Baseline (sin reducción de dimensionalidad)
Práctica 3 - Competición Kaggle

Hipótesis: XGBoost con todas las features (304) puede superar
al baseline de Logistic Regression debido a su capacidad de
...
def main():
    print("=" * 60)
    print("EXPERIMENTO 05: XGBOOST BASELINE (304 features)")
    ...
    # 4. Configurar y evaluar XGBoost
    print("\n[4] Evaluando XGBoost (5-fold CV)...")
    model = XGBClassifier(
        n_estimators=100,
        max_depth=6,
        learning_rate=0.1,
    ...
    model_fitted = model  # Ya está entrenado
    ...
    submission_filename = SUBMISSIONS_PATH / f'submission_05_xgboost_baseline_{timestamp}.csv'
