"""
Experimento 07: Logistic Regression con optimización de hiperparámetros
Práctica 3 - Competición Kaggle

Objetivo: Optimizar el parámetro C de regularización y probar diferentes solvers
para mejorar el F1-score del baseline (0.84782).
"""
...
def main():
    print("=" * 60)
    print("EXPERIMENTO 07: LOGISTIC REGRESSION OPTIMIZADO")
    ...
    submission_filename = SUBMISSIONS_PATH / f'submission_07_lr_optimized_{timestamp}.csv'
    ...
    print(f"Modelo: Logistic Regression (optimizado)")
